...
const PricingCard: React.FC<PricingCardProps> = ({ title, price, features = [], highlight = false, subtitle }) => (
  <article
  ...
  >
    <div className="mb-5 flex items-start justify-between gap-3">
      ...
      {highlight ? (
        <span className="rounded-full border border-[#00E5A8]/40 bg-[#00E5A8]/20 px-3 py-1 text-xs font-semibold text-[#00E5A8]">
          Popular
        </span>
      ) : null}
    </div>
      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-14 md:px-8 md:py-20">
        <section className="mb-16 text-center md:mb-24">
          ...
          <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
            <a href="#final-cta" className="w-full rounded-xl bg-[#00E5A8] px-7 py-3 text-center font-semibold text-black transition-transform hover:scale-[1.03] sm:w-auto">Get Started</a>
        ...
        <section id="branding" className="mb-16 md:mb-20">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <PricingCard title="Brand Identity" price="₹16,499" highlight features={['Unlimited revisions', 'Guidelines', 'Animation', 'Social kit']} />
          </div>
        </section>
        ...
        <section className="mb-16 md:mb-20">
          ...
          <div className="grid gap-6 lg:grid-cols-4">
            ...
            <PricingCard title="Growth" price="₹32,999" highlight />
        ...
        <section className="mb-16 md:mb-20">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <PricingCard title="Monthly" price="Meta ₹14,999 • Meta + Google ₹19,999 • Full System ₹29,999" highlight subtitle="₹19,999/month is our most popular growth plan" />
          </div>
        </section>
        ...
        <section className="mb-16 grid gap-6 md:grid-cols-2 md:mb-20">
          ...
          <PricingCard title="Custom Software" price="Pricing based on requirements" features={['SaaS', 'CRM', 'Automation', 'APIs']} subtitle="Request Custom Quote" />
        </section>
